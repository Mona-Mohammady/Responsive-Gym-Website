            ...
            <section id="home">
                <div className="container">
                    <div className="hero__wrapper row">
                        {/* hero content */}
                        <div className="hero__content col-md-8">
                            <div>
                            <h2 className="section__title"
                                data-aos='fade-up'
                                data-aos-duration="1500">Exersice is key of <span className="highlights">Healthy</span> Lifestyle</h2>
                            <p data-aos='fade-up'
                                data-aos-delay='100'
                                data-aos-duration="1800">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. <br />
                                    Illum harum minima veniam adipisci libero provident.</p>
                        ...
                        {/* hero img */}
                        <div className="hero__img col-md-4">
